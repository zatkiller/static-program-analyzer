...
public:
    ...
    /**
    * Checks whether the TransitiveRelationshipTable contains RELATIONSHIP(entity1, entity2).
    *
    ...
    * @return whether the relationship is present in the TransitiveRelationshipTable
    */
    virtual bool containsT(PKBField entity1, PKBField entity2) = 0;

    /**
    * Inserts a RELATIONSHIP(entity1, entity2) into the TransitiveRelationshipTable,
    * where RELATIONSHIP = Follows || Parents
    *
    * @param entity1 the first program design entity in the relationship
    * @param entity2 the second program design entity in the relationship
    ...
    * 
    * @param entity1 the first program design entity in the relationship
    * @param entity2 the first program design entity in the relationship
    *
