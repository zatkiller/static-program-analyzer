...
TEST_CASE("PKBResponse == Testing") {
    ...
    // Statement fields
    PKBField stmt1 = PKBFieldFactory::createConcreteField(STMT_LO{ 3, StatementType::Assignment });
    PKBField stmt2 = PKBFieldFactory::createConcreteField(STMT_LO{ 5, StatementType::Assignment });


    // Var fields
    PKBField var1 = PKBFieldFactory::createConcreteField(VAR_NAME{"a"});
