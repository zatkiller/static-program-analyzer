...
TEST_CASE("RelationshipRow operator testing") {  
    PKBField field1 = PKBFieldFactory::createConcreteField(VAR_NAME{"test"});
    PKBField field2 = PKBFieldFactory::createConcreteField(VAR_NAME{"test"});
    PKBField field3 = PKBFieldFactory::createConcreteField(VAR_NAME{"proc_test"});
